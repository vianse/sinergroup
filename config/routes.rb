Rails.application.routes.draw do
  ...
  # You can have the root of your site routed with "root"
   root 'control#index'
   get 'recomendaciones' => 'home#recomendaciones'
   get 'socios' => 'pedidos#socios'
   get 'aislados' => 'pedidos#aislados'
   get 'concentrados' => 'pedidos#concentrados'
